...
![Aula's login-side](/assets/images/loginproblemer/login-initial-screen-01.png)

2. Tryk på den blå "Unilogin/MitID/Lokalt login" knap

![Tryk på Unilogin/MitID/Lokalt login knappen](/assets/images/loginproblemer/login-unilogin-button-01.png)

3. Tryk på "Unilogin"

![Vælg Unilogin muligheden](/assets/images/loginproblemer/login-select-unilogin-01.png)

4. Indtast dit brugernavn - husk "@meddel.dk"!

![Indtast dit brugernavn med @meddel.dk](/assets/images/loginproblemer/login-username-input-01.png)

5. Tryk "Næste"

![Klik på Næste knappen](/assets/images/loginproblemer/login-next-button-01.png)

6. Dit brugernavn er allerede indsat. Indtast dit kodeord - det samme som du bruger til din Chromebook.

![Indtast dit kodeord](/assets/images/loginproblemer/login-password-input-01.png)

7. Tryk på "Login" knappen

![Klik på Login knappen](/assets/images/loginproblemer/login-login-button-01.png)

8. Du er nu kommet ind på Aula

![Du er nu logget ind på Aula](/assets/images/loginproblemer/login-success-01.png)
...
![Klik på Andre loginmuligheder](/assets/images/loginproblemer/login-other-options-01.png)

3. Tryk på "KOMMUNAL IDP"

![Vælg KOMMUNAL IDP](/assets/images/loginproblemer/login-kommunal-idp-01.png)

4. Tryk på "Vælg Kommune" og vælg "Ishøj"

![Vælg Ishøj kommune](/assets/images/loginproblemer/login-kommune-select-01.png)

5. Tryk på "OK"

![Klik på OK knappen](/assets/images/loginproblemer/login-ok-button-01.png)

6. Indtast dit brugernavn (@meddel.dk) og kodeord - det samme som til din Chromebook

![Indtast brugernavn og kodeord](/assets/images/loginproblemer/login-credentials-form-01.png)

7. Tryk på "Login"

![Klik på Login knappen](/assets/images/loginproblemer/login-submit-button-01.png)

8. Du er nu på Aula!

![Du er nu logget ind på Aula](/assets/images/loginproblemer/login-success-alt-01.png)
